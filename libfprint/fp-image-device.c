...
/* Callbacks/vfuncs */
static void fp_image_device_open(FpDevice* device)
{
...
static void fp_image_device_close(FpDevice* device)
{
...
static void fp_image_device_cancel_action(FpDevice* device)
{
    FpImageDevice* self = FP_IMAGE_DEVICE(device);
...
static void fp_image_device_start_capture_action(FpDevice* device)
{
    FpImageDevice* self = FP_IMAGE_DEVICE(device);
    FpImageDevicePrivate* priv = fp_image_device_get_instance_private(self);
    FpiDeviceAction action;
...
static void fp_image_device_finalize(GObject* object)
{
...
static void fp_image_device_default_activate(FpImageDevice* self)
{
    fpi_image_device_activate_complete(self, NULL);
}

static void fp_image_device_default_deactivate(FpImageDevice* self)
{
    fpi_image_device_deactivate_complete(self, NULL);
}

static void fp_image_device_get_property(GObject* object, guint prop_id,
...
static void fp_image_device_constructed(GObject* obj)
{
...
static void fp_image_device_class_init(FpImageDeviceClass* klass)
{
...
static void fp_image_device_init(FpImageDevice* self) {}
